...
screenshot-location: 1>Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\monitoring_pods_services.PNG
2>Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\observability_pods_services.PNG
3>Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\default_pods_services.PNG
...
screenshot-location:
1>Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\grafan_homepage.PNG
2>Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\prometheus_homepage.PNG
3>Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\jaeger_homepage.PNG

## Create a Basic Dashboard
Done*TODO:* Create a dashboard in Grafana that shows Prometheus as a source. Take a screenshot and include it here.
screenshot-location:
Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\Prometheus_basic_dashboard.png
...
screenshot-location:
Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\metrics_sli_last_6hrs.PNG
Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\metrics_sli_last_24hrs.PNG

## Tracing our Flask App
*TODO:*  We will create a Jaeger span to measure the processes on the backend. Once you fill in the span, provide a screenshot of it here. Also provide a (screenshot) sample Python file containing a trace and span code used to perform Jaeger traces on the backend service.
screenshot-location:
Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\span_from_grafana.PNG, span_backend_python_code.PNG

## Jaeger in Dashboards
*TODO:* Now that the trace is running, let's add the metric to our current Grafana dashboard. Once this is completed, provide a screenshot of it here.
screenshot-location:
Project_Starter_Files-Building_a_Metrics_Dashboard\answer-img\dashboard_using_traces.PNG
...
here i have captured the following Request Success Rate, Request Latency, Error Rate using this the required KPIs can be identified
